            ...
            <form action="{{ route('product.update',$product->id) }}"  method="POST"  enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <div class="image-input image-input-empty image-input-outline" id="kt_user_edit_avatar" style="background-image: url({{$product->photos ? asset( 'storage/uploads/thumb_' . $product->photos ):'' }})">
                        ...
                        <div class="form-group  ">
                            ...
                            <select name="attributes[]" class="form-control form-control-lg form-control-solid">
                                ...
                                @foreach($attribute->values as $value)
                                    <option value="{{ $value->id }}" {{ in_array($value->id, $product->attributes_id)  ? 'selected="selected"' : '' }}>{{ $value->value }}</option>
                                @endForeach
                            </select>
                        </div>
