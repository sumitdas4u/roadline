...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('attribute.create') }}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            ...
            @endif
            <form method="get"  action="{{ route('attribute-search') }}">
            <!--begin::Search Form-->
 ...
 <td>
     ...
     <a href="{{ URL::to('attribute/' . $attribute->id.'/edit') }}" class="btn btn-light btn-hover-success btn-sm btn-icon mr-2">
    ...
    <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Quick actions" data-placement="top">
         ...
         <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
             ...
             <ul class="navi navi-hover">
                 ...
                 <li class="navi-item">
                     <a href=" {{ route('attribute-values',$attribute->id) }}" class="navi-link">
														<span class="navi-icon">
															<i class="flaticon2-writing"></i>
														</span>
                         <span class="navi-text">Add values</span>
                     </a>
                     <a href=" {{ route('attribute-values-index',$attribute->id) }}" class="navi-link">
														<span class="navi-icon">
															<i class="flaticon2-analytics"></i>
														</span>
                         <span class="navi-text">Manage values</span>
                     </a>
                 </li>
        ...
        $(function() {
            ...
            $('.toggle-class').change(function() {
                ...
                $.ajax({
                    type: "PUT",
                    dataType: "json",
                    url: '{{ route('attribute.update.status') }}',
