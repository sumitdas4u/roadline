    ...
    <div class="login-form  pt-11">
        ...
        @csrf
            ...
            <div class="text-center pb-8">
                <h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Are you a truck owner</h2>
                <p class="text-muted font-weight-bold font-size-h4">Signup to resgiter your trucks.</p>
            </div>
            <!--end::Title-->
            <!--begin::Form group-->
